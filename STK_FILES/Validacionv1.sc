...
BEGIN Epoch
    ...
    Epoch        1 Jan 2024 01:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	1 Jan 2024 01:00:00.000000000
			EventEpoch
...
Start                   1 Jan 2024 01:00:00.000000000
Stop                    4 Feb 2024 16:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	1 Jan 2024 01:00:00.000000000
...
BEGIN QuickReports
    ...
    BEGIN Report
        Name    Inclination vs Time1
        Type    Graph
        SubDir   Mecatronic Systems\STK\Validacion STK
        Style    Inclination vs Time
        AGIViewer    No
        Instance    Satellite/TKSAT-1_Real
        BEGIN TimeData
            BEGIN Section
                SectionNumber    1
                SectionType      2
...
BEGIN Intervals
    ...
    "1 Jan 2024 01:00:00.000000000" "2 May 2024 22:52:00.000000000"
END Intervals
...
END IntervalList
        ...
        WindowRectTop     767
        WindowRectRight   416
        WindowRectBottom  795
    END Report

    BEGIN Report
        Name    Inclination vs Time2
        Type    Graph
        SubDir   Mecatronic Systems\STK\Validacion STK
        Style    Inclination vs Time
        AGIViewer    No
...
BEGIN Intervals
    ...
    "1 Jan 2024 01:00:00.000000000" "2 Oct 2024 13:55:00.000000000"
END Intervals
...
END IntervalList
        ...
        WindowRectBottom  791
    END Report

    BEGIN Report
        Name    Inclination vs Time3
        Type    Graph
        SubDir   Mecatronic Systems\STK\Validacion STK
        Style    Inclination vs Time
        AGIViewer    No
        ...
        WindowRectLeft    226
        WindowRectTop     105
        WindowRectRight   1703
        WindowRectBottom  583
    END Report

    BEGIN Report
        Name    Inclination vs Time
        Type    Graph
        SubDir   Mecatronic Systems\STK\Validacion STK
        Style    Inclination vs Time
        AGIViewer    No
        BEGIN InstanceList
            Instance    Satellite/TKSAT-1_RNN
            Instance    Satellite/TKSAT-1_Random_Forest
            Instance    Satellite/TKSAT-1_Real
        END InstanceList
        BEGIN TimeData
            BEGIN Section
...
BEGIN Extensions
    ...
    BEGIN ClsApp
		...
		LaunchWindowStart                       29689200.000
		LaunchWindowStop                        26784000.000
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	9 Dec 2024 16:00:00.000000000
				Stop	10 Dec 2024 16:00:00.000000000
			END Interval
			IntervalState	Explicit
	END	EVENTINTERVAL
...
BEGIN Animation
    ...
    StartTime          1 Jan 2024 01:00:00.000000000
    EndTime            4 Feb 2024 16:00:00.000000000
    CurrentTime        1 Jan 2024 08:23:00.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN SoftVTR
            OutputFormat     WMV
            Directory        C:\Users\Rodri-ABE\Documents\STK 11 (x64)\PruebaManiobraSur
            BaseName         Frame
            Digits           4
            Frame            0
...
BEGIN References
    ...
    Instance Satellite/TKSAT-1_RNN
        *
        Satellite/TKSAT-1_RNN
    END Instance
    Instance Satellite/TKSAT-1_Random_Forest
        Satellite/TKSAT-1_Random_Forest
    END Instance
    Instance Satellite/TKSAT-1_Real
        Satellite/TKSAT-1_Real
    END Instance
END References
